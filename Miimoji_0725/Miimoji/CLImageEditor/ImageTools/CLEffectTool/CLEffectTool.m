...
//    [self setEffectMenu];
    ...
    // Set Only Hue Effect
    self.selectedEffect = [[CLHueEffect alloc] initWithSuperView:self.editor.toolView imageViewFrame:self.editor.toolView.frame toolInfo:_selectedMenu.toolInfo];
