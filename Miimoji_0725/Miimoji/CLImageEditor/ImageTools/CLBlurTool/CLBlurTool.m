...
- (void)setup
{
    ...
    [_blurSlider setMinimumTrackTintColor:[UIColor purpleColor]];
    [_blurSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/blurThumb", [self class]]] forState:UIControlStateNormal];
    [_blurSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/blurThumb", [self class]]] forState:UIControlStateHighlighted];
