...
- (void)setup
{
    ...
    [_rotateSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/rotate", [self class]]] forState:UIControlStateNormal];
    [_rotateSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/rotate", [self class]]] forState:UIControlStateHighlighted];
    
    [_rotateSlider setMinimumTrackTintColor:[UIColor purpleColor]];
