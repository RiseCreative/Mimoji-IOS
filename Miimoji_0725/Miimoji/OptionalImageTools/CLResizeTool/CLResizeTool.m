...
- (void)setup
{
    ...
    _resizePanel.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.8];
...
#pragma mark - PREDEFINED SIZES BUTTONS =====================
...
- (void)initInfoPanel
{
   // UIFont *font = [CLImageEditorTheme toolbarTextFont];
    ...
    label.textAlignment = NSTextAlignmentCenter;
    label.font = [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:17];
    ...
    label = [[UILabel alloc] initWithFrame:CGRectMake(10, _infoPanel.height/2, _infoPanel.width-20, 50)];
    label.backgroundColor = [UIColor clearColor];
    label.textAlignment = NSTextAlignmentCenter;
    label.textColor = [UIColor whiteColor];
    label.font = [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:17];
    ...
    // Width TextField ============
    _fieldW = [[UITextField alloc] initWithFrame:CGRectMake(0, y+5, 100, 40)];
    _fieldW.font = [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:22];
    ...
    _fieldW.textColor = [UIColor whiteColor];
    ...
    // Height TextField ============
    _fieldH = [[UITextField alloc] initWithFrame:CGRectMake(_chainBtn.center.x + 40, y+5, 100, 40)];
    _fieldH.font = [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:22];
    ...
    _fieldH.textColor = [UIColor whiteColor];
